. .\config.ps1
# Online
Get-AppxProvisionedPackage -Online | Select-Object -ExpandProperty PackageName | ForEach-Object { $_.Trim() } | Where-Object { $_ -ne '' } > .\config\Get_Online_ProvisionedPackages.lst
